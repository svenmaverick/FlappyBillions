...
var pipeheight = 150; // wider gap for easier play
...
function showScore()
{
   ...
   $("#scoreboard").transition({ opacity: 1, transform: 'translate(-50%, -50%) translateY(0)'}, 400, 'ease', function() {
      ...
      soundSwoosh.stop();
      soundSwoosh.play();
      $("#replay").transition({ opacity: 1, transform: 'translate(-50%, 0) translateY(0)'}, 400, 'ease');
...
$("#replay").click(function() {
   ...
   $("#scoreboard").transition({ opacity: 0, transform: 'translate(-50%, -50%) translateY(20px)'}, 1000, 'ease', function() {
